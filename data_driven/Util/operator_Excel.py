...
class OPExcel:
    ...
    # 设置单元格样式
    def set_cell_style(self,rowNo=None,colNo=None,fontColor='7CFC00',bdColor='000000',fgColor="DDDDDD"):
        font=Font(color=colors.GREEN)
        bd=Side(style='thin',color=bdColor)
        fill=PatternFill(fill_type="solid",fgColor=fgColor)
        # 这两句表明如果不传行列号，说明操作整个单元格
...
if __name__ == "__main__":
    excel_data_file = r"C:\Users\LS\PycharmProjects\data_driven\TestData\qq邮箱联系人.xlsx"
